  ...
  // ------------------request data vars------------------------------------------------
              ...
              var urlApi= "https://api.propublica.org/congress/v1/113/house/members.json"
  ...
  // ------------------fetching data to props------------------------------------------------
              ...
              .then( () => {mostMembers.sort(orderByMostAttendance);
                           leastMembers.sort(orderByLeastAttendance);
                            })
